    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/jAlert").Include(
                        "~/Scripts/plugins/jAlert/jAlert-v2-min.js"));

            // html2canvas
            bundles.Add(new ScriptBundle("~/plugins/html2canvas").Include(
                        "~/Scripts/plugins/Html2Canvas/html2canvas.js"));

            bundles.Add(new ScriptBundle("~/plugins/html2canvas-extra").Include(
                        "~/Scripts/plugins/Html2Canvas/jquery.plugin.html2canvas.js"));

            bundles.Add(new ScriptBundle("~/plugins/Canvg").Include(
                       "~/Scripts/plugins/Canvg/canvg.js",
                       "~/Scripts/plugins/Canvg/rgbcolor.js",
                       "~/Scripts/plugins/Canvg/StackBlur.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/HighCharts-More").Include(
            ...
            // jAlert css
            bundles.Add(new ScriptBundle("~/plugins/jAlertStyles").Include(
                       "~/Content/plugins/jAlert/jAlert-v2-min.css"));
            ...
            //case
            bundles.Add(new ScriptBundle("~/app/case").Include(
                      "~/Scripts/app/case.js"));
            //casetypeahead
            bundles.Add(new ScriptBundle("~/app/casetypeahead").Include(
                      "~/Scripts/app/casetypeahead.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/select").Include(
                "~/Scripts/plugins/select/bootstrap-select.min.js"));

            // bootstrap-select styles
            bundles.Add(new StyleBundle("~/plugins/selectStyles").Include(
                "~/Content/plugins/select/bootstrap-select.min.css"));
            ...
            // typeahead
            bundles.Add(new ScriptBundle("~/plugins/typeahead").Include(
                      "~/Scripts/plugins/typeahead/typeahead.jquery.min.js"));

            //TimePicker
            bundles.Add(new ScriptBundle("~/plugins/jquery.timepicker").Include(
                      "~/Scripts/plugins/TimePicker/jquery.timepicker.min.js"));

            //TimePicker Styles
            bundles.Add(new ScriptBundle("~/plugins/jquery.timepickerStyle").Include(
                     "~/Scripts/plugins/TimePicker/jquery.timepicker.css"));
